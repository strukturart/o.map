...
document.addEventListener("DOMContentLoaded", function () {
  ...
  let build_menu = function () {
    ...
    el.insertAdjacentHTML(
      "afterend",
      '<div class="item" data-type="map" data-url="https://c.tile.opentopomap.org/{z}/{x}/{y}.png" data-maxzoom="18" data-attribution="Kartendaten: © OpenStreetMap-Mitwirkende, SRTM | Kartendarstellung: © OpenTopoMap</a>(CC-BY-SA)">OpenTopoMap</div>'
    );
