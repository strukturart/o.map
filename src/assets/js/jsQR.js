!(function (o, e) {
  ...
  return (function (o) {
      ...
      e.binarize = function (o, e, r, n) {
        ...
        for (
          ...
          for (var v = 0; v < m; v++) {
            ...
            for (B = 0; B < c; B++)
              for (i = 0; i < c; i++) {
                var b = l.get(v * c + i, P * c + B);
                (h += b), (y = Math.min(y, b)), (p = Math.max(p, b));
              }
            var g = h / Math.pow(c, 2);
            if (p - y <= s && ((g = y / 2), P > 0 && v > 0)) {
              var x =
                (w.get(v, P - 1) + 2 * w.get(v - 1, P) + w.get(v - 1, P - 1)) /
                4;
              y < x && (g = x);
            }
            w.set(v, P, g);
    ...
    function (o, e, r) {
      ...
      function B(o, e) {
        for (
          var r = [], t = "", c = [8, 10, 12][e], s = o.readBits(c), d = 0;
          d < s;
          d++
        ) {
          var n = o.readBits(13),
    ...
    function (o, e, r) {
      ...
      function n(o, e, r, t) {
        ...
        for (
          ...
          if (
            r.get(v, h) !== f &&
            ((f = !f), l.push({ x: v, y: h }), l.length === t + 1)
          )
            break;
          if ((u += k) > 0) {
            if (P === n) break;
        ...
        for (var y = [], p = 0; p < t; p++)
          l[p] && l[p + 1] ? y.push(a(l[p], l[p + 1])) : y.push(0);
        return y;
      }
      function l(o, e, r, t) {
        var c,
      ...
      function B(o, e, r) {
        try {
          var t = l(o, { x: -1, y: o.y }, r, e.length),
            ...
            C =
              (d.averageSize + n.averageSize + B.averageSize + k.averageSize) /
              4;
          return (
            u +
            ...
            .map(function (e) {
              ...
              if (o.get(Math.floor(r), Math.floor(t))) {
                ...
                return {
                  ...
                  y: t,
                  score:
                    B({ x: Math.floor(r), y: Math.floor(t) }, [1, 1, 1], o) +
                    a({ x: r, y: t }, f),
                };
              }
            })
      ...
      e.locate = function (o) {
                    ...
                    if (n === i) a++;
                      ...
                      if (u) {
                        ...
                        (v = r.filter(function (o) {
                          return (
                            (w >= o.bottom.startX && w <= o.bottom.endX) ||
                            (f >= o.bottom.startX && w <= o.bottom.endX) ||
                            (w <= o.bottom.startX &&
                              f >= o.bottom.endX &&
                              B[2] / (o.bottom.endX - o.bottom.startX) < s &&
                              B[2] / (o.bottom.endX - o.bottom.startX) > c)
                          );
                        })).length > 0
                          ? (v[0].bottom = P)
                      ...
                      if (m) {
                        var v,
                          h = e - B[4],
                          y = h - B[3];
                        (P = { startX: y, y: t, endX: h }),
                          (v = l.filter(function (o) {
                            return (
                              (y >= o.bottom.startX && y <= o.bottom.endX) ||
                              (h >= o.bottom.startX && y <= o.bottom.endX) ||
                              (y <= o.bottom.startX &&
                                h >= o.bottom.endX &&
                                B[2] / (o.bottom.endX - o.bottom.startX) < s &&
                                B[2] / (o.bottom.endX - o.bottom.startX) > c)
        ...
        var f = (function (o, e, r) {
            ...
            return (
              k >= B && k >= u
                ? ((n = (t = [e, o, r])[0]), (l = t[1]), (i = t[2]))
                : u >= k && u >= B
                ? ((n = (c = [o, e, r])[0]), (l = c[1]), (i = c[2]))
                : ((n = (s = [o, r, e])[0]), (l = s[1]), (i = s[2])),
              (i.x - l.x) * (n.y - l.y) - (i.y - l.y) * (n.x - l.x) < 0 &&
                ((n = (d = [i, n])[0]), (i = d[1])),
              { bottomLeft: n, topLeft: l, topRight: i }
            );
          })(m[0].points[0], m[0].points[1], m[0].points[2]),
          w = f.topRight,
          P = f.topLeft,
          v = f.bottomLeft,
          h = u(o, n, w, P, v),
